...
//Getjobs
    .matches('risk', [
        function (session, args, next) 
        {
                session.send('Great! Let me help you conduct a risk profiling.', session.message.text);
...
function jetsocard(session) {
    return [ 
        ...
        .images([
            builder.CardImage.create(session, 'http://media.bizj.us/view/img/661021/genki-sushi-logo450x300*1024xx450-253-0-24.jpg')
        ])
        .buttons([
...
function pplcard(session) {
    return [ 
        ...
        .images([
            builder.CardImage.create(session, 'https://s17.postimg.org/j0yjw3qa7/good-01.png')
        ])
        .buttons([
...
function investcard(session) {
    return [ 
        ...
        .text('We analysed your expenditure pattern, we found out that actually you have underxxx your money. If you would like to explore available investment options, please click to start a risk assessment.')
        .buttons([
...
function incomecard(session) {
    return [ 
        ...
        .subtitle('Above shows where does your income mainly comes from')
        .text('If you want to expand our income sources, I can give you information of the available options!')
        .buttons([
